...
public class BaseClient {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(HttpMethod method,
        ...
        try {
            if (parameters != null) {
                statisticsResponse = restTemplate.exchange(path, method, requestEntity, Object.class, parameters);
            } else {
                statisticsResponse = restTemplate.exchange(path, method, requestEntity, Object.class);
            }
